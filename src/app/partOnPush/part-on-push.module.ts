...
@NgModule({
  declarations: [ContainerComponent, FirstComponent, SecondComponent, ThirdComponent, FourthComponent, FivesComponent,  SixthComponent, SeventhComponent, InputComponent],
  imports: [
    CommonModule,
    FormsModule,
